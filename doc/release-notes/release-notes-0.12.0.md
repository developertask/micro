...
Then, to tunnel a SSL connection on 23132 to a RPC server bound on localhost on port 13132 do:

    stunnel -d 23132 -r 127.0.0.1:13132 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ProxyPass http://127.0.0.1:3132/
        ProxyPassReverse http://127.0.0.1:3132/
