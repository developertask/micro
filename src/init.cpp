...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-bootstrap", _("Enables Micro Bitcoin bootstrap mode. Allows BTG client to connect to Bitcoin p2p network to download blockahin history."));
